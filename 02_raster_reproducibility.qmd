...
Start today with an RMarkdown or Quarto file.
...
```{r pull, fig.align='center',fig.cap="Pull request. Source: [codex (2024) ](https://codex.so/fork-and-pull-en)", out.width="30%", fig.show='hold', echo=FALSE, cache=FALSE}
